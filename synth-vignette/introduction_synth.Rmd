...
#thetas$isocntry <- as.factor(thetas$isocntry) #first round has no country info
...
```{r viz-thetas, eval=T, echo=T, eval=F, echo=T, message=F, warning = FALSE}
library(ggplot2) #version: ggplot2_3.4.4 
library(ggridges) #version: ggridges_0.5.6 
library(RColorBrewer) #version: RColorBrewer_1.1-3
library(dplyr) #version: dplyr_1.1.4
...
```{r medtrust-viz, eval=F, echo=T, message=F, warning = FALSE}
